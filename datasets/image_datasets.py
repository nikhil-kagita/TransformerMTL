...
def build_image_dataset(args):
    ...
    if args.dataset == 'imagenet':
        ...
        from datasets.nyuv2_dataloader_adashare import NYU_v2
        dataset_train = NYU_v2('data/nyu_v2', 'train', crop_h=224, crop_w=224)
        dataset_val = NYU_v2('data/nyu_v2', 'test', crop_h=224, crop_w=224)
        nb_classes = 40
    else:
